...
class TrainingAcademyRepository {
    ...
    /**
     * Uploads image Uri to Firebase Storage under 'training_academies' path.
     */
    suspend fun uploadImageToStorage(context: Context, uri: Uri, folder: String = "training_academies"): Result<String> {
